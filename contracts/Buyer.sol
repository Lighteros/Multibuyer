...
contract Buyer {
    ...
    function buyV2(
        ...
        ITargetRouter(router).swapETHForExactTokens{value: msg.value}(
            amountOut,
            path,
            address(this),
            block.timestamp
    ...
    function buyV3(
        ...
        ITargetRouter(router).exactOutputSingle{value: msg.value}(
    ...
    function buyV3ExactInput(
        ...
        ITargetRouter(router).exactInputSingle{value: msg.value}(
